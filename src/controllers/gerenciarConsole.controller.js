...
async function cadastrarConsole(req, res){
    ...
    // Verifica Descrição do Console
        ...
        res.send(await gerenciarConsoleServices.cadastrarConsole(inputModel, inputProducer, inputLaunchDate, inputOriginality, inputPrice, inputConsoleDescription));
    }
...
async function editarConsole(req, res){
    ...
    const { inputConsoleId, inputModel, inputProducer, inputLaunchDate, inputOriginality, inputPrice, inputConsoleDescription  } = req.body;
    ...
    // Verifica Descrição do Console
        ...
        res.send(await gerenciarConsoleServices.editarConsole(inputConsoleId, inputModel, inputProducer, inputLaunchDate, inputOriginality, inputPrice, inputConsoleDescription));
    }
